...
class BaseMenuRenderClass implements MenuRenderInterface
{
    ...
    /**
     * @var \Qobo\Menu\MenuBuilder\Menu $menu
     */
    protected $menu = null;
     ...
     *  __construct method
     *
     * @param \Qobo\Menu\MenuBuilder\Menu $menu menu to render
     ...
     *
     * @param \Qobo\Menu\MenuBuilder\MenuItemInterface $item menu item definition
